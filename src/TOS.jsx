...
class TOS extends React.Component {
  ...
  render() {
    return (
      <div className="TOS">
          <h1>Terms and Conditions for The Company</h1>

<h2>Introduction</h2> 
  
<p>These Website Standard Terms and Conditions written on this webpage shall manage your use of our website, The Company accessible at https://cs506-acp.web.app/.</p>
...
<p>The The Company is allowed to assign, transfer, and subcontract its rights and/or obligations under these Terms without any notification. However, you are not allowed to assign, transfer, or subcontract any of your rights and/or obligations under these Terms.</p>
